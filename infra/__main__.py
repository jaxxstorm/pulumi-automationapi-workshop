...
# Create a DNS domain
dns_domain = do.Domain("workshop-domain", name="pulumi-workshop.net")
...
k8s_provider = k8s.Provider(
    ...
    __opts__=pulumi.ResourceOptions(parent=cluster)
)
...
ns = k8s.core.v1.Namespace(
    ...
    __opts__=pulumi.ResourceOptions(provider=k8s_provider, parent=k8s_provider),
)
...
external_dns = k8s.helm.v3.Chart(
    ...
    k8s.helm.v3.ChartOpts(
        ...
        values={
            ...
            "domainFilters": [ "pulumi-workshop.net" ],
            "digitalocean": {
                "apiToken": token
            }
        }
