...
class ClusterIssuer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['kind'] = 'ClusterIssuer'
            __props__['metadata'] = metadata
            __props__['spec'] = spec
            __props__['status'] = status
        super(ClusterIssuer, __self__).__init__(
            'kubernetes:cert-manager.io/v1alpha2:ClusterIssuer',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.ClusterIssuerSpec']]:
        """
