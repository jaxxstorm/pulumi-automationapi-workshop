...
class CertificateSpec(dict):
    ...
    def __init__(__self__, *,
                 ...
                 email_sans: Optional[Sequence[str]] = None,
                 ...
                 organization: Optional[Sequence[str]] = None,
        ...
        :param Sequence[str] email_sans: EmailSANs is a list of email subjectAltNames to be set on the Certificate.
        ...
        :param str key_algorithm: KeyAlgorithm is the private key algorithm of the corresponding private key for this certificate. If provided, allowed values are either `rsa` or `ecdsa` If `keyAlgorithm` is specified and `keySize` is not provided, key size of 256 will be used for `ecdsa` key algorithm and key size of 2048 will be used for `rsa` key algorithm.
        :param str key_encoding: KeyEncoding is the private key cryptography standards (PKCS) for this certificate's private key to be encoded in. If provided, allowed values are `pkcs1` and `pkcs8` standing for PKCS#1 and PKCS#8, respectively. If KeyEncoding is not specified, then `pkcs1` will be used by default.
        :param int key_size: KeySize is the key bit size of the corresponding private key for this certificate. If `keyAlgorithm` is set to `rsa`, valid values are `2048`, `4096` or `8192`, and will default to `2048` if not specified. If `keyAlgorithm` is set to `ecdsa`, valid values are `256`, `384` or `521`, and will default to `256` if not specified. No other values are allowed.
        ...
        :param Sequence[str] organization: Organization is a list of organizations to be used on the Certificate.
        ...
        :param Sequence[str] uri_sans: URISANs is a list of URI subjectAltNames to be set on the Certificate.
    ...
    def email_sans(self) -> Optional[Sequence[str]]:
        """
    ...
    def key_encoding(self) -> Optional[str]:
        """
    ...
    @property
    @pulumi.getter
    def organization(self) -> Optional[Sequence[str]]:
        """
    ...
    def uri_sans(self) -> Optional[Sequence[str]]:
        """
...
class CertificateSpecKeystoresJks(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        JKS configures options for storing a JKS keystore in the `spec.secretName` Secret resource.
        :param bool create: Create enables JKS keystore creation for the Certificate. If true, a file named `keystore.jks` will be created in the target Secret resource, encrypted using the password stored in `passwordSecretRef`. The keystore file will only be updated upon re-issuance.
...
class CertificateSpecKeystoresPkcs12(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        PKCS12 configures options for storing a PKCS12 keystore in the `spec.secretName` Secret resource.
        :param bool create: Create enables PKCS12 keystore creation for the Certificate. If true, a file named `keystore.p12` will be created in the target Secret resource, encrypted using the password stored in `passwordSecretRef`. The keystore file will only be updated upon re-issuance.
